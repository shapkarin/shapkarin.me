...
const Footer = () =>
    <footer className="Footer">
        ...
        This website has been under gradual development since 2013, <b>with limited time dedicated to its progress</b>.<br/>
        Feel free to check long history on Web Archive {'=> '}<a href="https://web.archive.org/web/20130801000000*/shapkarin.me" target="_blank" rel="noreferrer">Proof<FiExternalLink /></a>{' | '}
