      ...
      <Fragment>
        ...
        <Collapse open={isMoreInfo}>
          <div style={{ marginTop: 10 }}>
            <hr />
            <div className="p">
              UPD: Will be migrated to next.js
              The site is published on gh-pages. Dependecies: React, React Hooks, React Query, Github API <a href="https://github.com/shapkarin/shapkarin.me/blob/master/package.json" target="_blank" rel="noreferrer">and other</a><br />
