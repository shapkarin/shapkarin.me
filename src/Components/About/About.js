    ...
    <>
      <div className={clsx('About', {
        ...
        <div className='Socials'>
          <a href={linkedin.link} className="Social_Linkl" target="_blank" rel="noreferrer">{linkedin.text}<FiExternalLink /></a>
          <a href={github.link} className="Social_Linkl" target="_blank" rel="noreferrer">{github.text}<FiExternalLink /></a>
        </div>
