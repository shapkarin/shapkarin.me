  ...
  return (
    <Fragment>
      <div className={'About About_dark'}>
        ...
        <br/><br/>
        PS: This site API is generated by <a href="https://github.com/shapkarin/shapkarin.me/tree/master/src/Generate-Backend" target="_blank" rel="noreferrer">this code</a><FiExternalLink /> and stored as JSON files on GitHub Pages.
      </div>
    </Fragment>
  )
}
