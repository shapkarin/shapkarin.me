  ...
  return (
    <Fragment>
      <div className={'About About_dark'}>
        ...
        <ul>
          <li>
            <a href="https://drive.google.com/file/d/155imY9utcyQEj68yxZL3V0ygnyjlwpMw/view" target="_blank" rel="noreferrer">My CV in PDF at Google Drive <FiExternalLink /></a>
          </li>
          <li>
