...
- [Bitcoin's Revolutionary Approach to Byzantine Fault Tolerance](#bitcoin-s-revolutionary-approach-to-byzantine-fault-tolerance)
  ...
  - [Bitcoin's Probabilistic Finality](#bitcoin-s-probabilistic-finality)
  - [Bitcoin's Complete BFT Architecture](#bitcoin-s-complete-bft-architecture)
...
- [Real-World BFT Implementations](#real-world-bft-implementations)
  - [Ethereum 2.0 Case Study](#ethereum-2-0-case-study)
...
![Diagram](/articles/light/byzantine-fault-tolerance-0.svg)
```mermaid
...
![Diagram](/articles/light/byzantine-fault-tolerance-1.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
sequenceDiagram
...
![Diagram](/articles/light/byzantine-fault-tolerance-2.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-3.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart LR
...
![Diagram](/articles/light/byzantine-fault-tolerance-4.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
graph TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-5.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-6.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
sequenceDiagram
...
![Diagram](/articles/light/byzantine-fault-tolerance-7.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
graph TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-8.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-9.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-10.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
graph LR
...
![Diagram](/articles/light/byzantine-fault-tolerance-11.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
graph TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-12.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
graph TB
...
![Diagram](/articles/light/byzantine-fault-tolerance-13.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-14.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
sequenceDiagram
...
![Diagram](/articles/light/byzantine-fault-tolerance-17.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
graph LR
...
![Diagram](/articles/light/byzantine-fault-tolerance-18.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
sequenceDiagram
...
![Diagram](/articles/light/byzantine-fault-tolerance-19.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
graph TD
...
![Diagram: BFT Stake Distribution](/articles/light/byzantine-fault-tolerance-20.svg)
```mermaid
...
![Diagram](/articles/light/byzantine-fault-tolerance-21.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart TD
...
![Diagram](/articles/light/byzantine-fault-tolerance-22.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
mindmap
...
![Diagram](/articles/light/byzantine-fault-tolerance-23.svg)
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#ffffff', 'fontSize':'16px'}}}%%
flowchart LR
