...
![Diagram](/articles/light/LavaMoat-against-JS-supply-chain-attacks-0.svg)
```mermaid
mindmap
...
![SequenceDiagram diagram](/articles/light/LavaMoat-against-JS-supply-chain-attacks-1.svg)
```mermaid
sequenceDiagram
    participant User
...
![ClassDiagram diagram](/articles/light/LavaMoat-against-JS-supply-chain-attacks-2.svg)
```mermaid
classDiagram
    Policy --> Resources
